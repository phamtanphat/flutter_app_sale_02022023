...
import 'package:flutter_app_sale_02022023/presentations/sign_up/bloc/sign_up_bloc.dart';
...
import 'package:flutter_app_sale_02022023/utils/string_utils.dart';
import 'package:provider/provider.dart';

import '../../../common/widgets/loading_widget.dart';
import '../../../common/widgets/progress_listener_widget.dart';
import '../../../data/datasources/remote/api_request.dart';
import '../../data/datasources/repositories/authentication_repository.dart';
    ...
    return LoadingWidget(
      ...
      child: SafeArea(
        child: Column(
          ...
          children: [
            Expanded(
                flex: 1, child: Image.asset("assets/images/ic_food_express.png")),
            Expanded(
                flex: 4,
                child: LayoutBuilder(
